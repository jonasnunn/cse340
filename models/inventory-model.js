...
module.exports = {getClassifications, getInventoryByClassificationId, getCarByInvId, addClass};


/* *****************************
*   Add a new car 
* *************************** */
async function addInv(classification_id, inv_make, inv_model, inv_year, inv_description, inv_image, inv_thumbnail, inv_price, inv_miles, inv_color){
  try {
...
module.exports = {getClassifications, getInventoryByClassificationId, getCarByInvId, addClass, addInv, updateInventory, deleteInventory};